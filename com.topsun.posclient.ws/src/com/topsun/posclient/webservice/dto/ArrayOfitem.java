...
import com.topsun.posclient.webservice.dto.imports.ExtensionMapper;
                ...
                if (localItemTracker){
                                       if (localItem!=null){
                                            for (int i = 0;i < localItem.length;i++){
                                                if (localItem[i] != null){
                                                 localItem[i].serialize(new javax.xml.namespace.QName("http://www.topsunit.com/rms","item"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://www.topsunit.com/rms", "item", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static ArrayOfitem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ArrayOfitem object =
                new ArrayOfitem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfitem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ArrayOfitem)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.topsunit.com/rms","item").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.topsunit.com/rms","item").equals(reader.getName())){
