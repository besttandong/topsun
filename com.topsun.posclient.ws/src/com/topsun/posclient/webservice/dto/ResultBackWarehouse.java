...
/**
 * ResultBackWarehouse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ResultBackWarehouse implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * resultBackWarehouse Namespace URI = http://www.topsunit.com/rms Namespace
	 * Prefix = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":resultBackWarehouse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ResultBackWarehouse parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ResultBackWarehouse object = new ResultBackWarehouse();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"resultBackWarehouse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ResultBackWarehouse) ExtensionMapper
