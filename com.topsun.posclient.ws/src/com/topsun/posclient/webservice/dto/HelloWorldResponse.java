...
/**
 * HelloWorldResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class HelloWorldResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.topsunit.com/rms", "helloWorldResponse", "ns1");
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localHelloWorldResultTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "helloWorldResult"));

			elementList.add(localHelloWorldResult == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
			...
			try {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://www.topsunit.com/rms",
								"helloWorldResult").equals(reader.getName())) {
