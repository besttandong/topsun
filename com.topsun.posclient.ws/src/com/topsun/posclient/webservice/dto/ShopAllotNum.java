...
/**
 * ShopAllotNum bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ShopAllotNum implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * shopAllotNum Namespace URI = http://www.topsunit.com/rms Namespace Prefix
	 * = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":shopAllotNum", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ShopAllotNum parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ShopAllotNum object = new ShopAllotNum();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"shopAllotNum".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ShopAllotNum) ExtensionMapper
