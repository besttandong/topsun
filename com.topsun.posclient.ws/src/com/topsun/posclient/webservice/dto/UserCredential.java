...
/**
 * UserCredential bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class UserCredential implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * userCredential Namespace URI = http://www.topsunit.com/rms Namespace
	 * Prefix = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":userCredential", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localPassWordTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "passWord"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static UserCredential parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			UserCredential object = new UserCredential();
						...
						if (!"userCredential".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (UserCredential) ExtensionMapper
