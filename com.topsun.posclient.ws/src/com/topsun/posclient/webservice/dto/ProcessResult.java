...
public class ProcessResult implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * processResult Namespace URI = http://www.topsunit.com/rms Namespace
	 * Prefix = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":processResult", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localFlagTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "flag"));
			...
			try {
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setMsg(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
