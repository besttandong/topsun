...
/**
 * SyncItemDataReqCondition bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class SyncItemDataReqCondition implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * syncItemDataReqCondition Namespace URI = http://www.topsunit.com/rms
	...
	protected java.util.Calendar localFinishTime;
	 ...
	 *            FinishTime
	 */
	public void setFinishTime(java.util.Calendar param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":syncItemDataReqCondition",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"syncItemDataReqCondition", xmlWriter);
			}
		...
		if (localFinishTimeTracker) {
			namespace = "http://www.topsunit.com/rms";
			writeStartElement(null, namespace, "finishTime", xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localStartTimeTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "startTime"));
		...
		if (localFinishTimeTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "finishTime"));

			elementList.add(localFinishTime == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localFinishTime));
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SyncItemDataReqCondition parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			SyncItemDataReqCondition object = new SyncItemDataReqCondition();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"syncItemDataReqCondition".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (SyncItemDataReqCondition) ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setFinishTime(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToDateTime(content));
