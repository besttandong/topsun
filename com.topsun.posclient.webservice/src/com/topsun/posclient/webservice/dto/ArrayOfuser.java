...
/**
 * ArrayOfuser bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ArrayOfuser implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ArrayOfuser Namespace URI = http://www.topsunit.com/rms Namespace Prefix
	 * = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfuser", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfuser", xmlWriter);
			}
		...
		if (localUserTracker) {
			if (localUser != null) {
				for (int i = 0; i < localUser.length; i++) {
					if (localUser[i] != null) {
						localUser[i].serialize(new javax.xml.namespace.QName(
								"http://www.topsunit.com/rms", "user"),
								xmlWriter);
					} else {
				...
				writeStartElement(null, "http://www.topsunit.com/rms", "user",
						xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ArrayOfuser parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ArrayOfuser object = new ArrayOfuser();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfuser".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ArrayOfuser) ExtensionMapper
