...
public class GetUserInfoResult implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * getUserInfoResult Namespace URI = http://www.topsunit.com/rms Namespace
	 * Prefix = ns1
	 */
	...
	protected ArrayOfuser localUsers;
	 ...
	 *            Users
	 */
	public void setUsers(ArrayOfuser param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":getUserInfoResult", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
		...
		if (localUsersTracker) {
			if (localUsers == null) {
				...
				writeStartElement(null, "http://www.topsunit.com/rms", "users",
						xmlWriter);
				...
				localUsers.serialize(new javax.xml.namespace.QName(
						"http://www.topsunit.com/rms", "users"), xmlWriter);
			}
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localUsersTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "users"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetUserInfoResult parse(
			...
			try {
						...
						if (!"getUserInfoResult".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetUserInfoResult) ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
						...
						object.setUsers(ArrayOfuser.Factory.parse(reader));
