/**
 * QueryReturnRepositoryReqCondition.java
 *
...
/**
 * QueryReturnRepositoryReqCondition bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class QueryReturnRepositoryReqCondition implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * queryReturnRepositoryReqCondition Namespace URI =
	 * http://www.topsunit.com/rms Namespace Prefix = ns1
	 */
	...
	/**
	 * field for WarehouseID
	 */

	protected int localWarehouseID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localWarehouseIDTracker = false;

	public boolean isWarehouseIDSpecified() {
		return localWarehouseIDTracker;
	}
	 ...
	 *            WarehouseID
	 */
	public void setWarehouseID(int param) {
		localWarehouseIDTracker = true;

		this.localWarehouseID = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":queryReturnRepositoryReqCondition",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"queryReturnRepositoryReqCondition", xmlWriter);
			}
		...
		if (localShopIdTracker) {
			...
			if (localShopId == java.lang.Integer.MIN_VALUE) {
		...
		if (localWarehouseIDTracker) {
			namespace = "http://www.topsunit.com/rms";
			writeStartElement(null, namespace, "warehouseID", xmlWriter);

			if (localWarehouseID == java.lang.Integer.MIN_VALUE) {
				...
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localWarehouseID));
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localWarehouseIDTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://www.topsunit.com/rms", "warehouseID"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static QueryReturnRepositoryReqCondition parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			QueryReturnRepositoryReqCondition object = new QueryReturnRepositoryReqCondition();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"queryReturnRepositoryReqCondition".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (QueryReturnRepositoryReqCondition) ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setShopId(java.lang.Integer.MIN_VALUE);
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setWarehouseID(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToInt(content));

					} else {

						object.setWarehouseID(java.lang.Integer.MIN_VALUE);
