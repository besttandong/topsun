...
/**
 * ProcessResultE bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ProcessResultE implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.topsunit.com/rms", "processResult", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (localProcessResult == null) {
			...
			writeStartElement(null, namespace, "processResult", xmlWriter);
			...
			localProcessResult.serialize(MY_QNAME, xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localProcessResult == null) {
			...
			return localProcessResult.getPullParser(MY_QNAME);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ProcessResultE parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ProcessResultE object = new ProcessResultE();
