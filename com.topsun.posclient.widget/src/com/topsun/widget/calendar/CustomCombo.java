 ...
 * </dl>
 * 
 * @see <a href="http://www.eclipse.org/swt/snippets/#CustomCombo">CustomCombo snippets<
 *      /a>
...
public class CustomCombo extends Composite {
	...
	public void deselect(int index) {
		checkWidget();
		if (0 <= index && index < list.getItemCount() && index == list.getSelectionIndex() && text.getText().equals(list.getItem(index))) {
