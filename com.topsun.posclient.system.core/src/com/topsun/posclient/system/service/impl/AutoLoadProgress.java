/*******************************************************************************
 * $Header: /cvsroot/prototype/01_src/refactor/ui-framework/com.icbc.desktop.ui/src/com/icbc/desktop/ui/menu/control/appmenu/AutoLoadProgress.java,v 1.1 2011/09/27 01:01:50 yujie Exp $
 * $Revision: 1.1 $
...
public class AutoLoadProgress extends Composite implements IProgressMonitor {
	 ...
	 */
	public AutoLoadProgress(Composite parent, Layout layout) {
	 ...
	 *            its layout.
	 */
	public AutoLoadProgress(Composite parent, Layout layout, int progressIndicatorHeight) {
	 ...
	 * @since 3.6
	 */
	public AutoLoadProgress(Composite parent, Layout layout, boolean createStopButton) {
		super(parent, SWT.NONE);
    ...
    public void beginTask(String name, int totalWork) {
    	...
    	fProgressIndicator.addMouseListener(new MouseListener() {
